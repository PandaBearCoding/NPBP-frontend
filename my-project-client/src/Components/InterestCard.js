...
class InterestCard extends React.Component{
    ...
    render(){
        // console.log("DOES IT WORK??", this.props.items)
    
        let { category, avatar } = this.props.interest
        // console.log("JOHNNIE", this.props.interest)
        return(
            <div className="interestcard" >
                <NavLink to={`/interests/${this.props.interest.id}/items`}>
                ...
                <ItemContainer interest={this.props.interest}  />
